...
const TrashBox = () => {
  ...
  const [search, setSearch] = useState(""); // ✅ always called
  ...
  if (!user || !user.emailAddresses?.[0]?.emailAddress) {
    return null; // yoki <Loader /> qaytaring
  }
  ...
  // Replace this with your actual logic to get the user's plan, e.g. from user metadata or API
  const plan = "Free"; // Example: hardcoded for demonstration
